  ...
  static Map<String, String> _getTranslations(String languageCode) {
    ...
    final translations = <String, Map<String, String>>{
      ...
      'es': {
        ...
        "startCodingMessage":
            "Comienza a codificar tu aplicación personalizando esta pantalla de inicio.",
        ...
        "quicklyDialNumber": "Marcar rápidamente un número de teléfono",
        ...
        "imageAddedGallery": "¡Imagen agregada desde la galería!",
        ...
        "numberCopied": "¡{number} copiado!",
        "contactAlreadySaved": "¡Contacto ya guardado!",
